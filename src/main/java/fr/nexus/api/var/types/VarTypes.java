...
import fr.nexus.api.var.types.parents.normal.bukkit.chunk.ChunkType;
import fr.nexus.api.var.types.parents.normal.bukkit.inventory.InventoryType;
import fr.nexus.api.var.types.parents.normal.bukkit.itemstack.ItemStackType;
import fr.nexus.api.var.types.parents.normal.bukkit.location.LocationType;
import fr.nexus.api.var.types.parents.normal.bukkit.world.WorldType;
