...
import fr.nexus.var.events.DataSetEvent;
import fr.nexus.var.events.DataSetEventType;
import fr.nexus.var.types.VarSubType;
import fr.nexus.var.types.parents.Vars;
import fr.nexus.var.types.parents.map.MapType;
import fr.nexus.var.types.parents.map.MapVarType;
