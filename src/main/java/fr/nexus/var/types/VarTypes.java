...
import fr.nexus.var.types.parents.normal.adventure.ComponentType;
import fr.nexus.var.types.parents.normal.big.BigDecimalType;
import fr.nexus.var.types.parents.normal.big.BigIntegerType;
import fr.nexus.var.types.parents.normal.bukkit.*;
import fr.nexus.var.types.parents.normal.java.*;
import fr.nexus.var.types.parents.normal.java.date.*;
